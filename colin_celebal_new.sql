create database colin_celebal_new
use colin_celebal_new
...
ALTER DATABASE colin_celebal_new ADD FILEGROUP colin_mix1 CONTAINS MEMORY_OPTIMIZED_DATA   
ALTER DATABASE colin_celebal_new ADD FILE (name='colin_mix1', filename='e:\all_codes_akash_new_server\all_filegroup\colin_mix1') TO FILEGROUP colin_mix1   
ALTER DATABASE colin_celebal_new SET MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT=ON  
GO 
